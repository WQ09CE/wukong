...
## 召唤检查清单 (Summoning Validation)

> **戒模块联动**: 本检查清单由戒模块在本体发起召唤时执行

### 4 部分声明验证

```
⛔ BLOCKING - 缺失任何一项 = 驳回召唤
...
```
⛔ BLOCKING - 缺失任何一段 = 驳回召唤

□ TASK - 具体、原子级目标
  └── ❌ 模糊/多目标 → 驳回，要求拆分

□ EXPECTED OUTCOME - 可验证交付物
  └── ❌ 无验证方式 → 驳回，要求补充
